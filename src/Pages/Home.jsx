...
import aboutImg from '../assets/wholesale-about-us.jpg'
  ...
  return (
    <div className="w-full">
      ...
      <div class="grid grid-cols-3 gap-4 px-4 py-4">
        ...
        <div class="p-4 w-full object-cover rounded-xl row-span-3">
          <img src={aboutImg} alt="About Us" className="object-cover w-full h-full rounded-xl" />
        </div>

        <div class="col-span-2 row-span-3 flex flex-col">

          <div class="p-4 w-full rounded-xl">
            <h1 className="text-4xl font-bold text-gray-300">About Us</h1>
          </div>
